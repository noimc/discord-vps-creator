...
wget -O main.py https://raw.githubusercontent.com/katy-the-kat/discord-vps-creator/refs/heads/main/v2d
...
sed -i "s/TOKEN = ''/TOKEN = '$DISCORD_TOKEN'/" v2d
echo "Starting the Discord bot..."
echo "To start the bot in the future, run: python3 v2d"
python3 v2d
